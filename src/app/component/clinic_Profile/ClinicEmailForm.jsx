            ...
            <div className="flex gap-3 justify-center mb-4" dir="ltr">
              {otp.map((digit, i) => (
                <input
                  ...
                  className="w-full h-14 text-center text-2xl font-bold border-2 border-gray-300 rounded-xl focus:border-[#7c5cff] focus:ring-2 focus:ring-[#7c5cff]/20 outline-none transition bg-white"
                  autoFocus={i === 0}
                  disabled={loading}
                />
              ))}
