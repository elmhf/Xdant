...
export default function ImageUploader({ onUpload }) {
  ...
  return (
    ...
    >
      {({ onImageUpload }) => (
        <div 
          className="relative flex items-center justify-center w-full h-full rounded-lg border-2 border-dashed border-gray-300 hover:border-blue-500 transition-colors cursor-pointer bg-gray-50"
