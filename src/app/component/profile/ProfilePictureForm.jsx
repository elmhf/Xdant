    ...
    <div className="p-6 pt-2 space-y-6">
      ...
      <div className="flex flex-col items-center space-y-6">
        <div className="relative">
          <img
            ...
            className="w-32 h-32 rounded-full object-cover border-4 border-[#7c5cff]/20 shadow-xl"
          />
        ...
        <Button
          className="w-full h-12 text-base font-semibold border-2 border-[#7c5cff] text-[#7c5cff] hover:bg-[#7c5cff] hover:text-white transition-all duration-200"
          variant="outline"
      ...
      {isUploading && (
        <div className="flex gap-3 items-center justify-center p-4 bg-blue-50 border-2 border-blue-200 rounded-xl">
          <div className="animate-spin rounded-full w-6 h-6 border-2 border-[#7c5cff] border-t-transparent"></div>
          <span className="text-[#7c5cff] font-semibold">Téléchargement en cours...</span>
        </div>
      )}
