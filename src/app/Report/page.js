"use client";
import ReportPage from '../component/dashboard/pdf/report/report';
import { useDentalStore } from "@/stores/dataStore";
import { motion } from "framer-motion";
import Lottie from "lottie-react";
import emptyAnimation from "@/app/Lottie/empty.json"; // استخدم Lottie للرسوم المتحركة

function Page() {
  const { hasData, isLoading } = useDentalStore(); // افترض أن لديك حالة isLoading في الـ store
    ...
    return (
      ...
      >
        ...
        <motion.button
          ...
          onClick={() => window.location.href = "/dashboard/upload"} // مثال لإعادة التوجيه
        >
