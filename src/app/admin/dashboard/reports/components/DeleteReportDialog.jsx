...
export const DeleteReportDialog = ({
    ...
    const reportType = report.raport_type || report.type || 'Report';
            ...
            <DialogContent className="bg-white border text-left border-gray-200 shadow-xl max-w-lg sm:max-w-[500px] p-6 gap-4">
                ...
                <div className="flex flex-col gap-1 py-2">
                    <p className="text-gray-600 text-lg">
                        Are you sure you want to delete <span className="font-bold text-gray-900">{reportType} #{reportId?.toString().substring(0, 8)}</span>?
                    </p>
