            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <label
                  ...
                  className={`w-full h-56 border-2 border-dashed rounded-xl flex items-center justify-center transition-all duration-200 bg-white relative overflow-hidden ${canEditClinic ? 'cursor-pointer' : 'cursor-default'
                    } ${logoLoading
                      ? 'border-[#7564ed] cursor-not-allowed bg-[#7564ed]/5'
                      : logoError
                        ? 'border-red-300 hover:border-red-400 hover:bg-red-50'
                        : 'border-gray-300 hover:border-[#7564ed] hover:bg-[#7564ed]/5'
                    }`}
                >
                  {logoLoading ? (
