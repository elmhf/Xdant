...
export default function SignatureCard({ signature, onSave }) {
  ...
  return (
    <div className="max-w-md w-full rounded-2xl shadow-sm border border-gray-200 p-6 bg-white">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Signature et tampon</h2>
        <div className="text-lg font-medium text-gray-600">Signature individuelle</div>
      </div>
      ...
      {!editing ? (
        <>
          <div className="w-full h-64 flex items-center justify-center rounded-xl border-2 border-dashed border-purple-300 bg-gray-50 mb-6 overflow-hidden">
            {isSaving ? (
              <div className="flex flex-col items-center justify-center w-full h-full">
                <LoadingSpinner size="w-12 h-12" />
                <span className="text-purple-600 mt-3 font-medium">Enregistrement de la signature...</span>
                {optimisticSignature && (
              ...
              <div className="flex flex-col items-center justify-center w-full h-full">
                ...
                <span className="text-purple-500 mt-2">Téléchargement de la signature...</span>
                {optimisticSignature && (
                  <img src={optimisticSignature} alt="معاينة التوقيع" className="max-h-32 max-w-full object-contain opacity-60 mt-2 rounded" />
                )}
              </div>
              ...
              <div className="text-center text-purple-500 px-4">
          ...
          <div className="flex gap-3 w-full">
            <Button
              className="flex-1 bg-[#6a5acd] hover:bg-[#625a97] text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <Button
              variant="outline"
              className="flex-1 border-[#6a5acd] text-[#6a5acd] hover:bg-[#e6e6fa] rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <>
          <div className="w-full mb-4 relative rounded-xl overflow-hidden">
            ...
            {isSaving && (
              <div className="absolute inset-0 bg-white bg-opacity-90 flex items-center justify-center z-20 rounded-xl">
                <div className="flex flex-col items-center">
                  <LoadingSpinner size="w-10 h-10" />
                  <span className="text-purple-600 mt-2 font-medium">Enregistrement de la signature...</span>
                </div>
              </div>
            )}
            ...
            <svg
              ...
              height="300"
              viewBox="0 0 400 300"
              className={`cursor-crosshair w-full border-2 border-dashed border-purple-300 bg-white rounded-xl transition-all duration-75 ${isSaving ? 'pointer-events-none opacity-50' : ''}`}
            ...
            {/* Pressure indicator */}
            {isDrawing && !isSaving && (
              <div className="absolute top-2 left-2 bg-[#0d0c22] bg-opacity-75 text-white px-2 py-1 rounded text-xs">
            ...
            <div className="flex justify-between items-center gap-2">
              ...
              <div className="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  className="text-purple-600 border-purple-400 hover:bg-purple-50 disabled:opacity-50 disabled:cursor-not-allowed"
