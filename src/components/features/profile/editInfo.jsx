        ...
        {!selectedOption ? (
          <div className="p-8">
            ...
            <div className="flex flex-col items-center pt-4 pb-6">
              <div className="relative">
                <img
                  ...
                  alt="Profile"
                  className="w-20 h-20 rounded-full object-cover border-4 border-[#7564ed]/20 shadow-lg"
                />
            ...
            <div className="space-y-2">
              <button
                className="w-full justify-between h-14 text-lg font-medium text-gray-700 hover:bg-gray-50 hover:text-[#7564ed] transition-all duration-200 flex items-center px-4 rounded-lg"
