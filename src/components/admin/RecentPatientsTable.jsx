        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col h-full">
            <div className="p-6 border-b border-gray-100 flex items-center justify-between">
                <div className="space-y-1">
                    <p className="text-4xl font-semibold text-gray-900">New Patients</p>
                    <p className="text-md font-medium text-gray-500">Newest patient records created.</p>
                </div>
            ...
            <div className="overflow-x-auto flex-1">
                <table className="w-full">
                    <thead className="bg-gray-100/20 border-b border-gray-200 sticky top-0 z-10 filter backdrop-blur-sm">
                        <tr>
                            <th className="min-w-64 text-left py-3 px-6 text-lg font-medium text-gray-700">Patient Name</th>
                            <th className="min-w-32 text-left py-3 px-6 text-lg font-medium text-gray-700">Clinic</th>
                            <th className="min-w-32 text-left py-3 px-6 text-lg font-medium text-gray-700">Date Added</th>
                        </tr>
                    </thead>
